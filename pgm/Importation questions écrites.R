...
json.file <- "src\\Questions_ecrites_XIV_json.json"
...
noms.var <- gsub("questionsEcrites.question.", "", noms.var,
                 fixed = T)
...
save(json.data.df, file = "tbl\\données propres importées des questions écrites.Rdata")
